        ...
        return (
            <div className="w-full bg-white py-16 px-4">
                <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 space-x-5 space-y-5">
                    <img ref={contentRef} className={`w-[500px] mx-auto my-4 rounded-xl ${animationClasses(contentVisible)}`} src={CustomWebsite} alt="/" />
                ...
                <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 space-x-5 space-y-5">
                    ...
                    <img ref={seoImgRef} className={`w-[500px] sm:w-full mx-auto my-4 rounded-xl ${animationClasses(seoImgVisible)}`} src={Laptop} alt="/" />
                </div>
            </div>
        );
    }
