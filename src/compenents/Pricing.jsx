...
const Pricing = () => {
  return (
    <>
        ...
        <div className="relative">
          ...
          >
            <h3 className="text-center text-4xl text-white my-2 sm:my-3">
              Let's talk <span className="text-red-500">Pricing</span>
            </h3>
            <p className="text-center text-xs sm:text-sm md:text-lg lg:text-xl text-white">
              ** Please note that all solutions are{" "}
              <span className="text-red-500">
                custom tailored and pricing may vary **
              </span>
            </p>
          </div>
          <img
      ...
      <div className="p-5">
        <section className="mb-8 py-4 overflow-hidden">
          <h2 className="text-3xl text-center  text-red-600 pb-2">
            ...
            <table className="min-w-full border-collapse bg-white">
              <thead>
                <tr
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, #351342 0%, #B51459 50%, #C00618 100%)",
                  }}
                >
                  <th className=" border-r-2 border-gray-300 text-[#fff]">
                    Tier
                  </th>
                  <th className=" border-r-2 border-gray-300 text-[#fff]">
                    Features
              ...
              <tbody>
                <tr className="border-b-2 border-gray-300">
                  <td className=" text-center py-4 px-6  border-l-2 border-r-2 border-gray-300">
                    Simple
                  </td>
                  <td className=" text-left border-r-2 px-6 border-gray-300">
                    Company information, pictures, services offered, Google
                    Analytics integration, Calendly integration, Social Sharing
                    buttons
                  </td>
                  <td className=" text-center border-r-2 border-gray-300">
                    $500 - $1000
                  </td>
                </tr>
                <tr className="bg-gray-50 border-b-2 border-gray-300">
                  ...
                  <td className=" text-left px-6 border-r-2 border-gray-300">
          ...
          <div className="mt-4 ">
            <h3 className="text-xl  py-2 text-[#FF0033]">
              (Optional) Add-ons:
            </h3>
        ...
        <section className="mb-8 bg-white   rounded-lg">
          <h2 className="text-3xl text-center  py-4 text-red-600">
        ...
        <section className="mb-8 bg-white  rounded-lg overflow-hidden">
          <h1 className="text-4xl text-center  text-red-600 py-4 bg-gray-100">
            SEO Services
          </h1>
          <hr />
          <div className="mb-4 ">
            <h2 className="text-3xl text-center  text-red-600 py-4">
              Technical SEO
            </h2>
          ...
          <div className="mb-4 ">
            <h3 className="text-xl  text-[#FF0033]">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-gray-300">
                <thead>
                  ...
                  >
                    <th className="py-2 px-4 border border-gray-300 text-white">
                      Maintenance Plan
                    </th>
                    <th className="py-2 px-4 border border-gray-300 text-white">
                      Update Fee (1-time)
        ...
        <section className="mb-8 ">
          ...
          <div className="mt-6">
            {/* Basic Plan */}
            <div className="mb-6">
              <h3 className="text-xl text-[#FF0033]   mb-2">
          ...
          {/* Additional Services */}
          <div className="mb-6">
            <h3 className="text-xl  mb-2 text-[#FF0033]">
              Additional Services:
            </h3>
            <ul className="list-disc pl-8">
          ...
          <h3 className="text-2xl  text-red-600 text-center  mb-4">
            SEO Services Pricing Chart:
          </h3>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse border border-gray-300">
              <thead>
                ...
                >
                  <th className="py-3 px-4  text-white border border-gray-300">
                    Service
                  </th>
                  <th className="py-3 px-4 text-white border border-gray-300">
                    Pricing
        ...
        <section className="mb-8 ">
          <h2 className="text-2xl  py-4 text-[#FF0033] ">Pricing Notes</h2>
