...
// import CaseStudies_UperBanner from "./CaseStudies_UperBanner";
      ...
      <div className="relative">
        ...
        <div className="py-8 px-32">
          <p className="py-8 px-8 text-2xl bg-gray-100 text-center shadow-black shadow-md ">
            ...
            <br></br>
            <br></br>
            With the help from Akira Web Solutions, these businesses are
            unlocking their digital potential. From AI chatbots enhancing
            customer engagement and support to custom website designs and
            strategic search engine optimization, our expertise is your
            advantage.
            <br></br>
            <br></br>
            <span className=" text-2xl text-center ">
              Schedule a meeting today to explore how we can bring exceptional
        ...
        <div className="flex justify-center space-x-4 ">
          ...
          >
            ...
            <p>
              ...
              it to the forefront of modern design...
            </p>
          </div>
          ...
          >
            <img
              src={BitcoinBayBot}
              alt="Bitcoinbay AI Chatbot Solution"
              className="w-full h-auto rounded mb-4"
            />
            <h2 className="text-2xl  mb-2">
          ...
          >
            <img
              ...
              alt="SeaverMarketingGroup Website Design"
              className="w-full h-auto rounded mb-4"
            />
            <h2 className="text-2xl  mb-2">
